...
$statement = $conn->prepare('UPDATE etudiant set Id_Etud=:id, nom=:nom, prenom=:prenom,adresse=:adresse ,classe=:classe  WHERE Id_Etud = :num');
...
$statement->bindvalue(':classe', $_POST['classe'],PDO::PARAM_STR);
