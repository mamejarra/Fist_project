...
require 'db.php';
    ...
    $req = 'SELECT * FROM professeur WHERE Id_prof = :num';
...
<div class="container">
        <div class="card mt-5">
            ...
            <div class="card-body">
                    ...
                    <?php endif; ?>
 <form method="post" action="pagmod1.php">
 <div class="form-group">
 <div class="form-group">
     <input type="hidden" class="form-control" name="modid" value="<?= $person['Id_prof']; ?>">
 </div>
     <label for="id">Identifiant:</label>
     <input type="text" class="form-control" id="id" name="id" value="<?= $person['Id_prof']; ?>">
 </div>
 <div class="form-group">
 ...
 <div class="form-group">
     <label for="module">Classe:</label>
     <input type="text" class="form-control" id="module" name="module" value="<?= $person['module']; ?>">
 </div>
 <div class="form-group">
